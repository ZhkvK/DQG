...
%			tick pos=left,
			...
			\nextgroupplot[ylabel={Self-diffusion coefficient, $Dn^{1/3}/c\cdot10^{-3}$}, xlabel={$ q $-gap, $q_gn^{-1/3}/\pi$},
			legend style={
				fill opacity=0, draw opacity=1, text opacity=1, draw=none, at={([yshift=0pt]0.27,0.68)},
				anchor=south,
				%				/tikz/every even column/.append style={column sep=0.2cm}
			},]
			...
			\node at (rel axis cs:0.14,0.92) {\textbf{(a) LJ 3D}};
			...
			\node at (rel axis cs:0.205,0.92) {\textbf{(b) Yukawa 3D}};
		\end{groupplot}
		\vspace{2cm}
	\end{tikzpicture}
\end{document}