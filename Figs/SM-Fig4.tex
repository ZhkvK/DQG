...
%		width=0.6\textwidth,
		...
		legend style={fill opacity=0.8, draw opacity=1, draw=none,, text opacity=1, at={([yshift=0pt]0.1,0.78)},
			anchor=south,},
		tick align=inside,
%		tick pos=left,
		x grid style={darkgray176},
%		xmajorgrids,
		xlabel={$ q $-gap, $q_gn^{-1/3}/\pi$},
		xmin=0,
...
%		table[x=x,y=y]{../vkr_norm/images/Dvsq_new/Al/1.0/fit2.7.txt};
		\addplot [semithick, crimson2143940, line width=0.5mm, mark=o, only marks, mark size=2, mark options={solid}]
		table[x=q,y=D]{Data/Fig5/Al.txt};
		\addlegendentry{Al};
		\addplot [semithick, crimson2143940, forget plot]
		table[x=x,y=y]{Data/Fig5/fitAl.txt};
		
		\addplot [semithick, steelblue31119180, line width=0.5mm, mark=o, only marks, mark size=2, mark options={solid}]
