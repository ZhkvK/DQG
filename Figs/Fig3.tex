...
%			tick pos=left,
			...
			\nextgroupplot[ylabel={Self-diffusion coefficient, $Dn^{1/3}/c\cdot10^{-3}$}, xlabel={$ q $-gap, $q_gn^{-1/3}/\pi$}, xmax=0.4,
			legend style={
...
%			\spy [black, size=2.5cm] on (2.9,1.2) in node at (3.5,4);
			...
			\nextgroupplot[ylabel={Self-diffusion coefficient, $Dn^{1/2}/c\cdot10^{-3}$}, xlabel={$ q $-gap, $q_gn^{-1/2}/\pi$},
			legend style={
