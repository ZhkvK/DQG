...
\begin{document}
	\begin{tikzpicture}[spy using outlines={
		...
		\begin{groupplot}[group style={group size=2 by 2, horizontal sep=2cm, vertical sep=0.25cm,
...
%			tick pos=left,
			...
			\nextgroupplot[ylabel={SDC, $Dn^{1/3}/c\cdot10^{-3}$}, ylabel shift=8pt, xmax=0.4,
			legend style={
			...
			\addplot [crimson2143940, forget plot, on layer=foreground]
...
%			table[x=x,y=y]{Data/Fig3/a/fit1.10.txt};
			...
			\addplot [darkorange25512714, forget plot, on layer=foreground]
...
%			table[x=x,y=y]{Data/Fig3/a/fit1.3.txt};
			...
			\addplot [blue, forget plot, on layer=foreground]
			...
			\addplot [cyan, forget plot, on layer=foreground]
			...
			\addplot [green, forget plot, on layer=foreground]
			...
			\addplot [red, forget plot, on layer=foreground]
...
%			\spy [black, size=2.5cm] on (2.9,1.2) in node at (3.5,4);
			...
			\nextgroupplot[ylabel={SDC, $Dn^{1/2}/c\cdot10^{-3}$},
			legend style={
				fill opacity=0, draw opacity=1, text opacity=1, draw=none, at={([yshift=0pt]0.05,0.85)},
				anchor=north west,
				%				/tikz/every even column/.append style={column sep=0.2cm}
...
%			table[x=x,y=y]{Data/Fig3/b/fit0.90_2.txt};\\
			...
			\node[anchor=west] at (rel axis cs:0.02,0.92) {\textbf{(b) LJ 2D}};
			
			%%%		YUKAWA		%%%
			
			\nextgroupplot[ylabel={SDC, $Dn^{1/3}/c\cdot10^{-2}$}, xlabel={$ q $-gap, $q_gn^{-1/3}/\pi$},
			legend style={
				fill opacity=0, draw opacity=1, text opacity=1, draw=none, at={([yshift=0pt]0.05,0.85)},
				anchor=north west,
				%				/tikz/every even column/.append style={column sep=0.2cm}
			...
			\node[anchor=west] at (rel axis cs:0.02,0.92) {\textbf{(c) Yukawa 3D}};
			
			\nextgroupplot[ylabel={SDC, $Dn^{1/2}/c\cdot10^{-2}$}, xlabel={$ q $-gap, $q_gn^{-1/2}/\pi$},
			legend style={
				fill opacity=0, draw opacity=1, text opacity=1, draw=none, at={([yshift=0pt]0.05,0.85)},
				anchor=north west,
				%				/tikz/every even column/.append style={column sep=0.2cm}
			...
			%			
			\node[anchor=west] at (rel axis cs:0.02,0.92) {\textbf{(d) Yukawa 2D}};
		\end{groupplot}
