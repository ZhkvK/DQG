...
\begin{document}
	...
	Fluids in states near the freezing line were considered. Chosen parameters for each system are represented in \href{https://www.latextemplates.com}{supplementary material}. The Lennard-Jones units are used for LJ and Yukawa systems throughout the paper.
	...
	Further, to obtain transverse dispersion relations $\omega_{L,T}(q)$ the values of $C_{L, T}(q, \omega)$ were investigated by two-oscillator model\cite{10.1038/s41598-019-46979-y}
	\begin{equation}
		\begin{aligned}
	...
	\begin{equation}
		...
		\label{DQG:Eq5}
	\end{equation}
	where $d$, as clarified earlier, is the space dimension. Calculated MSD$(t)$ dependencies for investigated systems are presented in \href{https://www.latextemplates.com}{supplementary material}.
	% \begin{figure}
	...
	To obtain $q$-gap values, dispersion relations $\omega_{L,T}(q)$ using fit by Eq. \eqref{DQG:Eq4} were calculated. The examples of low-frequency terms $\omega_{T}(q)$ for  \href{https://www.latextemplates.com}{supplementary material}.
%	\begin{figure*}
%		\centering
